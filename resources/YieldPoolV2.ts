...
export interface YieldPoolV2Interface extends utils.Interface {
  functions: {
    "accumulativeYield()": FunctionFragment;
    ...
    "yieldGrowthGlobal()": FunctionFragment;
  };

  encodeFunctionData(
    functionFragment: "accumulativeYield",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "yieldGrowthGlobal",
    values?: undefined
  ): string;
...
export interface YieldPoolV2 extends BaseContract {
  ...
  functions: {
    accumulativeYield(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    yieldGrowthGlobal(overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  populateTransaction: {
    accumulativeYield(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    yieldGrowthGlobal(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}

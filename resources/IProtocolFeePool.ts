...
export interface IProtocolFeePoolInterface extends utils.Interface {
  functions: {
...
export interface IProtocolFeePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IProtocolFeePoolInterface;

...
export interface MockMiningPoolInterface extends utils.Interface {
  functions: {
    ...
    "depositReward(uint128)": FunctionFragment;
...
export interface MockMiningPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockMiningPoolInterface;

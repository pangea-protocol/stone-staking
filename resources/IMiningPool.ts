...
export type PositionRewardStruct = {
  rewardGrowthInsideLast: BigNumberish;
  rewardOwed: BigNumberish;
};

export type PositionRewardStructOutput = [BigNumber, BigNumber] & {
...
export interface IMiningPoolInterface extends utils.Interface {
  functions: {
...
export interface IMiningPool extends BaseContract {
  ...
  functions: {
    ...
    positionRewards(
      ...
      upper: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[PositionRewardStructOutput]>;

...
export interface IConcentratedLiquidityPoolManagerEventInterface
...
export interface IConcentratedLiquidityPoolManagerEvent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IConcentratedLiquidityPoolManagerEventInterface;

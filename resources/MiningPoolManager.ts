...
export interface MiningPoolManagerInterface extends utils.Interface {
  functions: {
    ...
    "collectReward(uint256,address,bool)": FunctionFragment;
    ...
    "mintCallback(address,address,uint256,uint256)": FunctionFragment;
    ...
    "positionRewardAmount(uint256)": FunctionFragment;
    "positionRewards(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "positionRewardAmount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface MiningPoolManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MiningPoolManagerInterface;
  ...
  functions: {
    ...
    nftCount(
      ...
      [BigNumber, BigNumber] & { minted: BigNumber; burned: BigNumber }
    >;
  ...
  nftCount(
    overrides?: CallOverrides
  ): Promise<[BigNumber, BigNumber] & { minted: BigNumber; burned: BigNumber }>;

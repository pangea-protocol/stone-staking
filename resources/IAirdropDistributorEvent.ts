...
export interface IAirdropDistributorEventInterface extends utils.Interface {
  functions: {};
...
export interface IAirdropDistributorEvent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAirdropDistributorEventInterface;
